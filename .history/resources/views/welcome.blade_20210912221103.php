<x-guest-layout>
    <div class="flex flex-col bg-indigo-900 w-full h-screen" x-data="{
        ...
        <div class="flex fixed top-0 bg-gray-900 bg-opacity-60 items-center w-full h-full" x-show="showSubscritor" x-on:click.self="showSubscritor=false" x-on:keydown.escape="showSubscritor=false">
            <div class="m-auto bg-pink-500 shadow-2xl rounded-xl p-8">
                ...
                <form class="flex flex-col items-center p-24">
                    ...
                    <x-button class="py-3 px-5 mt-5 w-80 bg-blue-500 justify-center">Get in</x-button>
                </form>
            </div>
        </div>
    </div>
