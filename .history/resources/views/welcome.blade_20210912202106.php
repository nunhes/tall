    ...
    <div class="flex flex-col bg-indigo-900 w-full h-screen">
        ...
        <div class="flex container mx-auto items-center h-full">
            <div class="flex flex-col w-1/3">
                <h1 class="text-white font-bold text-5xl leading-tight">This is a simple genarili landin page</h1>
                <p class="text-indigo-200 text-xl mb-10">We are only cheeting up</p>
